...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-7f9d25ec50994a75"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-7f9d25ec50994a75",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-7f9d25ec50994a75",
        "url": "https://en.wikipedia.org/wiki/Shephard%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Shephard's problem (a.k.a. Dürer's conjecture) – does every convex polyhedron have a net , or simple edge-unfolding?",
      "version": 1
    },
    "title": "Shephard's problem (a.k.a. Dürer's conjecture)",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "276d7e924bc067402c3b90b10a73b43e984abd72daa2a2476b27d52ff2814cf9"
}
```
